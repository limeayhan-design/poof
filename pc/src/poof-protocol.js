...
export const PoofMessageType = Object.freeze({
  ...
  RemoteListResponse: 'remoteListResponse',
  RemoteGetRequest: 'remoteGetRequest',
  ScreenMirrorStart: 'screenMirrorStart',
  ScreenMirrorStop: 'screenMirrorStop',
  ScreenMirrorFrame: 'screenMirrorFrame',
  Ping: 'ping',
  Pong: 'pong',
});
